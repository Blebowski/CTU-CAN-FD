...
ts_sim_coverage.py -o merged_compliance_min_phases sim_tb_rtl_test_compliance_full_min_phases* --clear
...
mv ../coverage_output/merged_compliance_min_phases.vdb merged_compliance_min_phases/simv.vdb
...
cp sim_tb_rtl_test_nightly_alc_ide_*/_ts_flow_reference_elaboration_directory merged_compliance_min_phases
...
ts_sim_coverage.py merged_compliance_max merged_compliance_min_phases merged_compliance_typ merged_fast merged_nightly -o merged_total --clear
